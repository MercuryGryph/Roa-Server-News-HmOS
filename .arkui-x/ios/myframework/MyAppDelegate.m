...
#import "RoaNewsRoaNewsAbilityViewController.h"
#import <libarkui_ios/StageApplication.h>

#define BUNDLE_DIRECTORY @"/Frameworks/myframework.framework/arkui-x"
#define BUNDLE_NAME @"cn.mercury9.roa.news.hmos"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *instanceName = [NSString stringWithFormat:@"%@:%@:%@",BUNDLE_NAME, @"roaNews", @"RoaNewsAbility"];
    RoaNewsRoaNewsAbilityViewController *mainView = [[RoaNewsRoaNewsAbilityViewController alloc] initWithInstanceName:instanceName];
...
- (BOOL)handleOpenUrlWithBundleName:(NSString *)bundleName
    ...
    if ([moduleName isEqualToString:@"roaNews"] && [abilityName isEqualToString:@"RoaNewsAbility"]) {
        NSString *instanceName = [NSString stringWithFormat:@"%@:%@:%@",bundleName, moduleName, abilityName];
        RoaNewsRoaNewsAbilityViewController *otherVC = [[RoaNewsRoaNewsAbilityViewController alloc] initWithInstanceName:instanceName];
        subStageVC = (RoaNewsRoaNewsAbilityViewController *)otherVC;
    } else if ([moduleName isEqualToString:@"roaNews"] && [abilityName isEqualToString:@"RoaNewsAbility"]) {
        NSString *instanceName = [NSString stringWithFormat:@"%@:%@:%@",bundleName, moduleName, abilityName];
        RoaNewsRoaNewsAbilityViewController *otherVC = [[RoaNewsRoaNewsAbilityViewController alloc] initWithInstanceName:instanceName];
        subStageVC = (RoaNewsRoaNewsAbilityViewController *)otherVC;
